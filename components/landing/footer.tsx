...
export function Footer() {
  return (
    <footer className="border-t border-border/30 mt-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
          <div className="col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-xs leading-relaxed">
              The modern way to share your online presence. Create beautiful, customizable bio pages
              in minutes.
            </p>
          </div>
